# 📊 🌐 Đo Lường Khoảng Trống AI: Đánh Giá Năng Lực Tự Động Hóa Và Nhu Cầu Của Người Lao Động Trong Khối CS
...
* **1. Tổng quan (Overview):** * Hiển thị thống kê nhanh số lượng mẫu và số ngành IT.
...
* **2. Phân tích Độ Lệch (Gap Analysis):** * Tính toán chỉ số lệch bằng công thức $Gap = \text{Worker Desire} - \text{Expert Capacity}$.
...
* **3. Phân tích Chuyên Sâu (CS Deep Dive):** * Cung cấp bộ lọc phân khúc (Demographic filters) để phân tích chéo hành vi theo số năm kinh nghiệm.
